...
public:
    ...
    */
	...
	void forEachChildElement(const function<void(XMLElement *)> &f);
    ...
    */
	...
	XMLElement * FirstChildElementOrThrow(const char *name = 0);

	// Returns the element text or throws an exception if the element is not found.
	string GetFirstChildElementTextOrThrow(const char *name = 0);

	// Returns the element text or an empty string if the element is not found.
	string GetFirstChildElementTextIfExists(const char *name = 0);
	...
	*/
	...
	int getLineNumber() const			{ return _parseLineNum; }
...
public:
    ...
    */
    ...
    string GetAttributeIfExists(const string &name) const;
    string GetAttributeOrThrow(const string &name) const;
    ...
    */
    ...
    /** Convenience function for easy access to the text inside an element. Although easy
    	...
    	returns the character string of the Text node, or else an empty string is returned.
...
public:
    ...
    */
    explicit XMLPrinter( FILE* file=0, bool compact = false, int depth = 0 );
    virtual ~XMLPrinter()	{}
